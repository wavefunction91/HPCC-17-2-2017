...
\begin{itemize}
  \color{white}
  \item[\color{white}] Simple Absorption
  \item[\color{white}] Circular Dichroism (CD)
  \item[\color{white}] High Harmonic Generation (HHG)
  \item[\color{white}] Vibrational Spectroscopy
  \begin{itemize}
    \color{white}
    \item[\color{white}] Infrared (IR)
    \item[\color{white}] Raman
  \end{itemize}
\end{itemize}
\end{column}
\end{columns}
...
\begin{itemize}
  \color{white}
  \item[\color{white}] Again, formally exact given the exact $E^{xc}$
  \item[\color{white}] Able to easily evaluate kinetic energy
  \item[\color{white}] Still trivially extendable to relativistic theory
\end{itemize}

\begin{itemize}
  \color{white}
  \item[\color{white}] $E^{xc}$ is still not known (we have to guess)
  \item[\color{white}] Orbitals introduce complications over density--only methods
\end{itemize}
\end{frame}
...
\begin{itemize}
  \color{white}
  \item[\color{white}] Exact (subject to machine epsilon)
\end{itemize}
\begin{itemize}
  \color{white}
  \item[\color{white}] O$(N^3)$ scaling
  \item[\color{white}] Not efficiently parallelizable
\end{itemize}
~\\
...
\begin{itemize}
  \color{white}
  \item[\color{white}] Very parallelizable (GEMM)
  \item[\color{white}] O$(N^3)$ scaling (with better prefactor)
\end{itemize}
\begin{itemize}
  \color{white}
  \item[\color{white}] Slowly convergent 
  \item[\color{white}] Round off errors
\end{itemize}
...
\begin{itemize}
  \color{white}
  \item[\color{white}] Very parallelizable (GEMM)
  \item[\color{white}] O$(N^3)$ scaling (with better prefactor than diagonalization)
  \item[\color{white}] Better round off than Taylor series at any given order
\end{itemize}
\begin{itemize}
  \color{white}
  \item[\color{white}] ????
